function changeBackground() {
  ...
  div.innerHTML = '<svg><path id="ring" fill="#00c790" stroke-width="2"/><path id="ring" fill="#00c790" />><circle cx="100" cy="100" r="73" fill="none" stroke="#00c790" stroke-width="2" opacity=".5"/><text x="100" y="100" text-anchor="middle" dominant-baseline="central" fill="#00c790" font-size="28" font-weight="400"></text></svg>';
