...
<br/>
  ...
  <div class="row">
      <div class="col-md-4">
          <div class="form-group">
              <label class="control-label" for="name">Товар</label>
              <input readonly="readonly" type="text" name="name" class="form-control" value="{{ $item['product']['name'] }}" >
          </div>
      </div>
  </div>
  ...
  <div class="row">
      <div class="col-md-4">
          <div class="form-group">
              ...
              <input readonly="readonly" type="text" name="city" class="form-control" value="{{ $item['city'] }}" >
          </div>
      </div>
  </div>
